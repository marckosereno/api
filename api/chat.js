...
//           adjuntando la ficha de categoría como dato opcional.
// ====================================================================
...
export default async function handler(req, res) {
    ...
    try {
        ...
        // La lógica de interceptación del prompt se ELIMINA para darle libertad a Gemini
        if (match) {
        ...
        // ⭐️ CAMBIO CRÍTICO: Inicializamos para permitir la estructura opcional
        ...
        try {
            ...
            if (jsonStart !== -1 && jsonEnd !== -1) {
                ...
                // 🛑 NUEVA LÓGICA: Revisa si la pregunta original es una recomendación para ADJUNTAR la ficha
                ...
                if (recMatch) {
                    ...
                    // Mapeo de Categorías (AJUSTADO PARA EL NUEVO MAPEO DE "PELUQUERÍA")
                    ...
                    else if (categoryKeyRaw.includes('peluqueria') || categoryKeyRaw.includes('estetica')) categoryName = "Peluquería / Salón de Belleza"; // <-- NUEVO MAPEO
                    ...
                    // Adjunta la Ficha de Categoría a la respuesta final
                    finalResponseData.hasStructuredOption = true;
                    finalResponseData.structuredOptionData = structuredOption;
                    
                    console.log(`Opción estructurada de categoría (${categoryName}) adjuntada a respuesta conversacional.`);
                }
